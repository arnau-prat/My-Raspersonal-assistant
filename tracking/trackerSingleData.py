...
class Tracker():
    def __init__(self, faceCasc = 'faces.xml', eyesCasc = 'eyes.xml', debug=False):
        ...
        self.counterRejectFaceHC = 0
        self.counterGoodFace = 0
        self.counterLKActive = 0
        self.counterFaceLost = 0
    ...
    def run(self):
        ...
        while True:
            ...
            if self.activeLKAlgorithm:
                ...
                self.counterFrames = self.counterFrames + 1
                print "**********************************************"
                print "Frames:", self.counterFrames
                print "Rejected Face:", self.counterRejectFaceHC
                print "Good Face:", self.counterGoodFace
                print "LK Algorithm Active:", self.counterLKActive
                print "Face Lost:", self.counterFaceLost
                print "**********************************************" 
                ...
                for i, (x,y,w,h) in enumerate(newFaces):
                    ...
                    if len(eyes) == 0:
                        ...
                        self.counterRejectFaceHC = self.counterRejectFaceHC + 1
                        continue
                ...
                if len(eyes) == 2 and nFace != -1:
                    ...
                    self.counterGoodFace = self.counterGoodFace + 1
                    ...
                    if len(oldFace) != 0:
                        ...
                        self.counterLKActive = self.counterLKActive + 1
                        if self.debug:
                        ...
                        self.counterFaceLost = self.counterFaceLost + 1
                        if self.debug:
                            print "******************No face****************"

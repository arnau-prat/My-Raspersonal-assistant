        ...
        while True:
            ...
            if self.activeLKAlgorithm:
                ...
                if rank == 0:
                    ...
                    comm.send(newFace2ToSend, dest=1)
                    ...
                    print "MPI:",((endTime - startTime)/cv2.getTickFrequency())

                if rank == 1:
                    oldGray2 = comm.recv(source=0)
